...
import com.jjl.shotrlink.admin.remote.dto.req.ShortLInkUpdateReqDTO;
...
public class ShortLinkRemoteService {
     ...
     * @return
     */
    public IPage<ShortLinkPageRespDTO> pageShortLink(ShortLinkRecycleBinPageReqDTO reqDTO) {
        Map<String, Object> requestMap = new HashMap<>();
        requestMap.put("gidList", reqDTO.getGidList());
        requestMap.put("current", reqDTO.getCurrent());
        requestMap.put("size", reqDTO.getSize());
