...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    public ShortLinkStatsRespDTO groupShortLinkStats(ShortLinkGroupStatsReqDTO requestParam) {
        ...
        return ShortLinkStatsRespDTO.builder()
                .pv(ObjectUtil.isNotNull(pvUvUidStatsByGroup)?pvUvUidStatsByGroup.getPv():0)
                .uv(ObjectUtil.isNotNull(pvUvUidStatsByGroup)?pvUvUidStatsByGroup.getUv():0)
                .uip(ObjectUtil.isNotNull(pvUvUidStatsByGroup)?pvUvUidStatsByGroup.getUip():0)
                .daily(daily)
                .localeCnStats(localeCnStats)
                .hourStats(hourStats)
                .topIpStats(topIpStats)
